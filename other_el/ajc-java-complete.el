 ...
 `ajc-parse-splited-line-4-complete-method'"
  (when stack-list
    ...
    (let( (is-dot-last  (= (% (length stack-list ) 2 ) 0))
      ...
      (message "22222222221111111111 111 %S top=%S" stack-list  top )
      ...
      (let ((class-item ))
        ...
        (message "22222222221111111111 %S" class-item)
        ...
        (if is-dot-last (let ((member-string (pop stack-list)))
                          ...
                          (message "0000000000000 %S %S %S %S" is-dot-last class-item member-string  stack-list )
                          (if member-string
